...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='1353731_1.jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default='/mnt/quedoulin/github_code/CenterNet/ctdet_helmet_opset9.onnx',
